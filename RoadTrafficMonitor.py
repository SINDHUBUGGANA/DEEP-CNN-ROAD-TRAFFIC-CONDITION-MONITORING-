...
main = tkinter.Tk()
main.title("Deep CNN Model for Condition Monitoring of Road Traffic") #designing main screen
...
def predictTraffic():
    ...
    if predict == 3:
        cv2.putText(img, 'Low Traffic Detected', (10, 25),  cv2.FONT_HERSHEY_SIMPLEX,0.6, (0, 255, 255), 2)
        msg = 'Low Traffic'
    cv2.imshow(msg,img)
    cv2.waitKey(0)
...
font = ('times', 16, 'bold')
title = Label(main, text='Deep CNN Model for Condition Monitoring of Road Traffic', justify=LEFT)
